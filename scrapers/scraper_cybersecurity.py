...
def get_scholarship_links():
    """
    Phase 1: Collect links from the list page (Cybersecurity category)
    """
    print(">>> Starting Phase 1: Collecting Cybersecurity scholarship links...")
    scholarship_urls = []
    
    # Specific URL for Cybersecurity major
    search_url = "https://www.scholarships.com/financial-aid/college-scholarships/scholarship-directory/academic-major/cybersecurity"
...
def extract_scholarship_data(url):
    ...
    try:
        ...
        # Fallback search if Contact section is missing
        if location == "USA":
...
def main():
    ...
    for index, url in enumerate(urls, 1):
        ...
        # Time interval to avoid IP blocking
        time.sleep(random.uniform(1.5, 3.0)) 
        
    print("\n>>> Saving data...")
    filename = 'cybersecurity_scholarships_data.json'
